...
export default class Bingo {
  ...
  static load() {
    ...
    if (localStorage.getItem("bingo")) {
      ...
      //      document.querySelector(`[data-number="${cardsWon[i]}"]`).classList.add("bingo__card--done");      // loop over the numbers 1, 7, 8 and mark those cards as done by adding the right CSS class
      // .bingo__card--done
      //  }
    }
    }
